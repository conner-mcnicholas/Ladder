...
for div in range (1,3):
    ...
    for pe in range(1,1+events):
        ...
        allplayers = list(pd.concat([played_event['Player A1'].str.strip(),played_event['Player A2'].str.strip(), \
                                    played_event['Player B1'].str.strip(),played_event['Player B2'].str.strip()]))
